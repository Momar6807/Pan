    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center marb-35">
          ...
          <p class="header-p">Acude a Panadería Magallanes, tu panadería de confianza.
            Decenas de clientes satisfechos son nuestra mejor recomendación.</p>
        </div>
        <div class="col-md-12  text-center gallery-trigger">
          <ul>
            <li><a class="filter" data-filter="all">Todo</a></li>
            <li><a class="filter" data-filter=".category-1">Galletas</a></li>
            <li><a class="filter" data-filter=".category-2">Panes</a></li>
            <li><a class="filter" data-filter=".category-3">Pito</a></li>
          </ul>
        </div>
        <div id="Container">
          <div class="mix category-1 menu-restaurant" data-myorder="2">
            <span class="clearfix">
                        <a class="menu-title" href="#" data-meal-img="assets/img/restaurant/rib.jpg">Panecito</a>
                        <span style="left: 166px; right: 44px;" class="menu-line"></span>
            <span class="menu-price">$20.99</span>
            </span>
            <span class="menu-subtitle">Descripcion</span>
          </div>
          <div class="mix category-1 menu-restaurant" data-myorder="2">
            <span class="clearfix">
                        <a class="menu-title" href="#" data-meal-img="assets/img/restaurant/rib.jpg">Galletita</a>
                        <span style="left: 166px; right: 44px;" class="menu-line"></span>
            <span class="menu-price">$20.99</span>
            </span>
            <span class="menu-subtitle">Descripcion</span>
